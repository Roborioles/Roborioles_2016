...
std::shared_ptr<Solenoid> RobotMap::chassisGShiftSolen;
std::shared_ptr<SpeedController> RobotMap::pickupThePickupMotor;
std::shared_ptr<Solenoid> RobotMap::pickupPickupSolen;
...
void RobotMap::init() {
    ...
    chassisGShiftSolen.reset(new Solenoid(0, 1));
    lw->AddActuator("Chassis", "GShiftSolen", chassisGShiftSolen);
    ...
    pickupPickupSolen.reset(new Solenoid(0, 0));
    lw->AddActuator("Pickup", "PickupSolen", pickupPickupSolen);
