...
OI::OI() {
    ...
    drive2.reset(new JoystickButton(rightJoy.get(), 2));
    drive2->WhenPressed(new DriveCmd());
    ...
    alignButton.reset(new JoystickButton(gamepad.get(), 7));
...
void OI::addButton(){
	alignButton->WhileHeld(new VisionCom());
}
