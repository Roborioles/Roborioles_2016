...
#include "Commands/AutoGroupVision.h"
...
std::shared_ptr<VisionCom> Robot::vision;
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=INITIALIZATION
Command *autonomousCommand;
bool Robot::enabled=false;
...
void Robot::RobotInit() {
	...
	Command* nothing=new AutonomousCommand();
	chooser->AddDefault("Do Nothing",nothing);
	chooser->AddObject("Cross Defense",new AutoDriveForward(10,0.5));
	chooser->AddObject("Cross Defense and Rotate",new AutoGroup1());
	chooser->AddObject("Cross Defense and Rotate - new",new AutoGroup2());
	chooser->AddObject("Portcullis/LowBar", new AutoPortcullis());
	chooser->AddObject("Vision Testing",new AutoGroupVision());
