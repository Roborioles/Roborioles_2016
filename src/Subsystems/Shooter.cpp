...
bool Shooter::CompareValues() {
	printf("SetPoint: %f,Current Value: %f\n",rightShooterMotor->GetSetpoint()/3,rightShooterMotor->PIDGet());
...
void Shooter::ResetResetSoleniods() {
	shooterSolenoid->Set(true);
}

void Shooter::SetThrottle(double speed){
	rightShooterMotor->Set(speed);
	leftShooterMotor->Set(speed);
}
